...
|-----------|----------|--------------|----------|
| **feral-connectd** | Go | ![feral-connectd](https://github.com/feral-file/feralfile-device/workflows/Component%20Testing/badge.svg?job=test-feral-connectd) | [![feral-connectd coverage](https://codecov.io/gh/feral-file/feralfile-device/branch/develop/graph/badge.svg?flag=feral-connectd)](https://codecov.io/gh/feral-file/feralfile-device) |
| **feral-setupd** | Rust | ![feral-setupd](https://github.com/feral-file/feralfile-device/workflows/Component%20Testing/badge.svg?job=test-feral-setupd) | [![feral-setupd coverage](https://codecov.io/gh/feral-file/feralfile-device/branch/develop/graph/badge.svg?flag=feral-setupd)](https://codecov.io/gh/feral-file/feralfile-device) |
...
This project is proprietary software developed by Bitmark Inc. for the Feral File platform.
